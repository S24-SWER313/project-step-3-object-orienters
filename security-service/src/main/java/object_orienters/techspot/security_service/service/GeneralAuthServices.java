package object_orienters.techspot.security_service.service;

import object_orienters.techspot.security_service.exceptions.EmailAlreadyExistsException;
import object_orienters.techspot.security_service.exceptions.ProfileNotFoundException;
...
import object_orienters.techspot.security_service.blacklist.ImpleTokenBlackListService;
import object_orienters.techspot.security_service.jwt.JwtUtils;
...
import object_orienters.techspot.security_service.payload.request.LoginRequest;
import object_orienters.techspot.security_service.payload.request.SignupRequest;
import object_orienters.techspot.security_service.payload.response.JwtResponse;
import object_orienters.techspot.security_service.repository.RefreshTokenRepository;
import object_orienters.techspot.security_service.repository.UserRepository;
...
public class GeneralAuthServices {
    ...
    public User registerUser(SignupRequest signUpRequest) throws IOException {
        ...
        userRepository.save(user);
        // profileService.createNewProfile(user.getUsername(), user.getEmail(), signUpRequest.getName()); // TODO Send request to profile service
    ...
    public void deleteUser(String username) {
        ...
        // profileRepository.delete(profile); // TODO Send request to profile service
    }
