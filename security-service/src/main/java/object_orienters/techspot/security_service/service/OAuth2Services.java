...
import object_orienters.techspot.security_service.repository.UserOAuthTempRepository;
...
public class OAuth2Services {
    ...
    public JwtResponse registerOuthUser(OAuthDto oAuthDto) throws IOException {
        ...
        // profileService.createNewProfile(user.getUsername(), user.getEmail(), userOAuthTemp.getName()); // TODO Send request to profile service
