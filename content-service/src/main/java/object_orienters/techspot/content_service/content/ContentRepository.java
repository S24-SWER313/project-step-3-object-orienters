...
public interface ContentRepository extends PagingAndSortingRepository<Content, Long> {
    ...
    Page<Content> findAllByMainAuthorAndContentTypeAndPrivacy(@Param("author") Profile author,
            @Param("privacies") List<Privacy> privacies, @Param("contentTypes") List<ContentType> contentTypes,
            Pageable pageable);
    ...
    Page<Content> findAllByMainAuthorsAndContentTypeAndPrivacy(@Param("authors") Set<Profile> authors,
            @Param("privacies") List<Privacy> privacies, @Param("contentTypes") List<ContentType> contentTypes,
            Pageable pageable);
