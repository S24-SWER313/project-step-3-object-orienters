...
import object_orienters.techspot.contentservice.exceptions.*;
// import object_orienters.techspot.contentservice.post.PostController;
// import object_orienters.techspot.contentservice.post.PostService;
...
public class CommentController {
    ...
    // org.slf4j.LoggerFactory.getLogger(CommentController.class);
    ...
    // Page<Comment> commentList = commentService.getComments(contentID, pageNumber,
    // pageSize);
    ...
    // linkTo(methodOn(CommentController.class).getComments(contentID, pageNumber,
    // pageSize)).withSelfRel(),
    ...
    public Integer getMethodName() {
        System.out.println("hi Angela and Husam");
        return 1;
    }
    ...
    // public ResponseEntity<?> updateComment(@PathVariable long contentID,
    // @PathVariable Long commentID,
    // @RequestParam(value = "files", required = false) List<MultipartFile> files,
    // @RequestParam(value = "text", required = false) String text) throws
    // IOException {
    // try {
    // logger.info(">>>>Updating Comment... @ " + getTimestamp() + "<<<<");
    // Comment updatedComment = commentService.updateComment(contentID, commentID,
    // files, text);
    ...
    // public ResponseEntity<?> deleteComment(@PathVariable long contentID,
    // @PathVariable Long commentID) {
    // try {
    // logger.info(">>>>Comment Added. @ " + getTimestamp() + "<<<<");
